...
class PaginaSemEvidenciaDeDoenca extends StatefulWidget {
  final Patient patient; // Add a patient parameter

  PaginaSemEvidenciaDeDoenca({Key? key, required this.patient}) : super(key: key);

  @override
  State<PaginaSemEvidenciaDeDoenca> createState() => _PaginaSemEvidenciaDeDoencaState();
}

class _PaginaSemEvidenciaDeDoencaState extends State<PaginaSemEvidenciaDeDoenca> {
